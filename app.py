...
def subir():
    ...
    server_ip = request.host.split(':')[0]  # IP o dominio público del servidor
    try:
        ...
        tx = {
            ...
            "gas": 24000, # Máxima cantidad de "trabajo" que se puede usar en una transacción 
        ...
        """
        create_Log(fecha_hora, "upload", filepath, hash_hex, "", tx_hash_str, "OK", "Archivo subido correctamente", "Usuario", server_ip, client_ip) # Guardar en el log
...
def bajar():
    ...
    try:
        ...
        create_Log(fecha_hora, "download", ruta_archivo, hash_local, hash_enviado, tx_hash, "OK", mensaje, "Usuario", server_ip, client_ip) # Guardar en el log
        ...
        create_Log(fecha_hora, "download", ruta_archivo, hash_local, "", tx_hash, "ERROR", str(e), "Usuario", server_ip, client_ip) # Guardar en el log
